...
export class EventService {
  ...
  getEventAssistance(): Observable<EventAssistanceResponse[]>{
    return this.http.get<EventAssistanceResponse[]>(`${this.apiUrl}/event/1/attendees/details`);
  }
  ...
  deleteEvents(id: number): Observable<EventConsoleResponse[]> {
    return this.http.delete<EventConsoleResponse[]>(`${this.apiUrl}/admin/users/${id}`);
  }
}
