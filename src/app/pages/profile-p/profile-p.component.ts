...
@Component({
  ...
  imports: [NavbarComponent, EventAsisttanceComponent, EventEditComponent, EventManagmentComponent,
    ...
    RouterLink, MatIcon, MatDivider, ProfileEditComponent, EventCreateComponent, EventSearchComponent,
...
export class ProfilePComponent {
  ...
  cambiarEstadoF() {
    this.currentPage = 'event-create';
  }

  cambiarEstadoG() {
    this.currentPage = 'event-search';
  }
